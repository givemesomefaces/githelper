...
import com.github.itisokey.githelper.gitlab.common.Constants;
...
public class GitLabDialogV2 extends DialogWrapper {
    ...
    private boolean filterProject(ProjectDto o, String searchWord) {
        ...
        if (StringUtils.isNotBlank(searchWord)) {
            searchProjectList = Arrays.stream(StringUtils.split(searchWord, Constants.NAME_SPLIT_SYMBOL)).collect(Collectors.toSet());
        }
